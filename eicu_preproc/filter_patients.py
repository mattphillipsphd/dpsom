...
if __name__ == "__main__":
    ...
    # Input paths
    parser.add_argument("--all_pid_stay_path",
            default=pj(HOME, "Datasets/eicu-2.0/all_pid_stays.txt"),
            help="Location of the file with all PIDs in the eICU database") 
    parser.add_argument("--vital_per_table_path",
    ...
    parser.add_argument("--output_path",
            ...
            help="Location of the list of included patients to output")

    # Parameters
    parser.add_argument("--min_length_days", type=int, default=5,
            help="Minimum length of a valid ICU stay in days")
    parser.add_argument("--max_length_days", type=int, default=30,
            help="Maximum length of a valid ICU stay in days")
    parser.add_argument("--max_hr_disconnect_mins", type=int, default=60,
            help="Max time in minutes that HR channel could be disconnected")
