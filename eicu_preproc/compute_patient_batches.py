...
def compute_patient_batches(configs):
    ...
    for batch_run_idx, base_idx in enumerate(range(0, len(pid_list),
    ...
    pickle_obj = {"batch_to_lst": batch_to_list_dict,
            "pid_to_batch": pid_to_batch_dict}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--included_pid_path",
            ...
            help="What is the path of the included PIDs?")

    # Output paths
    parser.add_argument("--output_path",
            default=pj(HOME, "Datasets/eicu-2.0/patient_batches.pickle"),
            help="What is the path to be used for the patient batch file")

    # Parameters
    parser.add_argument("--batch_size_patients_per_file", type=int,
            default=100,
            help="How many patients should be put into one batch file")
